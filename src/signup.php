    ...
    <div class="space-y-8 bg-white shadow-lg rounded-lg w-full max-w-md p-8">
        ...
        <form action="#" method="POST">
            ...
            <fieldset>
                ...
                <div class="mb-4">
                    <label for="first_name" class="cursor-pointer block mb-2 text-sm font-medium text-gray-700 dark:text-white">First Name</label>
            ...
            <div class="mb-4">
                <label for="password" class="cursor-pointer block mb-2 text-sm font-medium text-gray-700 dark:text-white">Password</label>
            ...
            <div class="mb-4">
                <label for="confirm-password" class="cursor-pointer block mb-2 text-sm font-medium text-gray-700 dark:text-white">Confirm Password</label>
            ...
            <div class="mb-4">
                <div class="flex items-start mb-5">
                    ...
                    <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with our <a href="#" class="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a></label>
                </div>
            </div>
