                    ...
                    <form action="#" method="POST">
                        ...
                        <fieldset>
                            <legend class="block w-full">
                                <div class="flex items-center gap-2 justify-between w-full mb-4">
                                    <hr class="w-full">
                                    <span class="block w-full text-nowrap text-center font-bold">Customer Information</span>
                                    <hr class="w-full">
                                </div>
                            </legend>
                        ...
                        <fieldset>
                            <legend class="block w-full">
                                <div class="flex items-center gap-2 justify-between w-full my-4">
                                    <hr class="w-full">
                                    <span class="block w-full text-nowrap text-center font-bold">Product Purchase Details</span>
                                    <hr class="w-full">
                                </div>
                            </legend>
                            ...
                            <div class="grid grid-cols-12 gap-4 items-end">
                                ...
                                <div class="col-span-12 lg:col-span-6">
                                    <label for="trackingID" class="cursor-pointer block mb-2 text-sm font-medium text-gray-700">Tracking ID</label>
                                    <input type="text" id="trackingID" name="trackingID" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                                </div>
                                <div class="col-span-12 lg:col-span-6">
                                    <label for="orderNumber" class="cursor-pointer block mb-2 text-sm font-medium text-gray-700">Order Number</label>
                                    <input type="text" id="orderNumber" name="orderNumber" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                                </div>
                                <div class="col-span-12">
                                    <label for="product-description" class="cursor-pointer block mb-2 text-sm font-medium text-gray-700">Product description</label>
                                    <textarea id="product-description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                                </div>
                                <div class="col-span-12">
                                    <label for="productWeight" class="cursor-pointer block mb-2 text-sm font-medium text-gray-700">Product Weight <span class="font-normal text-xs">(kg or lbs)</span></label>
                                    <input type="text" id="productWeight" name="productWeight" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                                </div>
                            </div>
                        </fieldset>
                        <!-- Submit Button -->
